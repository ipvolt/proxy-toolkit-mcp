...
As of 14 September 2026, the reviewed source and npm package are public. Registry listings and the public hosted endpoint remain pending.
...
| Official MCP Registry | Preparing the local npm package listing | Verify and publish the npm-only manifest through GitHub OIDC, then read back |
